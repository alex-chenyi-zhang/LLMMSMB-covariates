...
names_2 = ["chr2_1000_46000_100k_oe_gf2.txt", "chr2_10000_55000_100k_oe_gf2.txt", "chr2_19000_64000_100k_oe_gf2.txt",
			"chr2_28000_73000_100k_oe_gf2.txt", "chr2_37000_82000_100k_oe_gf2.txt"]
for i_name in 1:length(names)
	...
	for i_classes in 1:length(ks)
		run_inference_gauss(niters[i_classes], 1, 450, 8, "data/input/X_"*name, "data/input/Y_log_"*name_2,ks[i_classes])
